...
try {
    ...
    $sql = "SELECT member.name, plan.status, plan.flag,
        ...
        <table class="table table-bordered table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php
		            if ($result[$i]['flag']==0){ ?>
			            <a href="today_plan.php" class="btn btn-danger btn-outline-dark btn-lg text-white" role="button"><?php print $result[$i]['name']; ?></a>
		            <?php
		            } else {

			            switch($result[$i]['status']){
				            case '守口': ?>
					            <a href="today_plan.php" class="btn btn-outline-dark btn-lg" role="button"><?php print $result[$i]['name']; ?></a>
					            <?php break;
				            case '在宅': ?>
					            <a href="today_plan.php" class="btn btn-success btn-outline-dark btn-lg text-white" role="button"><?php print $result[$i]['name']; ?></a>
					            <?php break;
				            case '出張': ?>
					            <a href="today_plan.php" class="btn btn-warning btn-outline-dark btn-lg" role="button"><?php print $result[$i]['name']; ?></a>
					            <?php break;
				            default: ?>
					            <a href="today_plan.php" class="btn btn-danger btn-outline-dark btn-lg text-white" role="button"><?php print $result[$i]['name']; ?></a>
				                <?php break;
